...
if __name__ == '__main__':
    start_logging()
    check_plausibility(data_2014, "2014")
    check_plausibility(data_2015, "2015")
    check_plausibility(data_2016, "2016")
    check_plausibility(data_2017, "2017")
    check_plausibility(data_2018, "2018")
    check_plausibility(data_2019, "2019")
    my_tank = Tank()
    my_tank.tank_data()
    my_tank.category_1()
    my_tank.category_2()
